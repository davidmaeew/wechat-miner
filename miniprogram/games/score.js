...
export default class Score  {
  ...
  render(ctx, canvas, score) {
    ...
    //   percent = 1
    // }
    ctx.drawImage(this.scoreBG.image, canvas.screenWidth - 4 * NUMBER_WIDTH, 20, IMAGE_NUMBER_WIDHT * 1.5, IMAGE_NUMBER_HEIGHT * 2 / 3)
    let index = 0
    do {
      let num = score % 10
      // console.log("测试", num)
      ctx.drawImage(this.imagePool[num].image, canvas.screenWidth * 9 / 10 - index * NUMBER_WIDTH - 10, 25, IMAGE_NUMBER_WIDHT/ 2, IMAGE_NUMBER_HEIGHT/2)
      index++
